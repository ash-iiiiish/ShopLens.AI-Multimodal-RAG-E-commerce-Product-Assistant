"""
catalog.py — Product catalog data and text-building utilities.

This is the only file that knows what products exist.
Swap PRODUCT_CATALOG for a real DB query in production.
"""
import json
...
PRODUCT_CATALOG = [
    {
        "id": "P001", "name": "Nike Air Max 270 White Sneakers",
        "category": "Footwear", "brand": "Nike", "price": 150,
    ...
    {
        "id": "P002", "name": "Adidas Ultraboost 22 Running Shoes",
        "category": "Footwear", "brand": "Adidas", "price": 180,
    ...
    {
        "id": "P003", "name": "Apple MacBook Pro 14-inch M3",
    ...
    {
        "id": "P004", "name": "Dell XPS 15 Laptop",
        "category": "Laptop", "brand": "Dell", "price": 1799,
    ...
    {
        "id": "P005", "name": "Sony WH-1000XM5 Headphones",
        "category": "Audio", "brand": "Sony", "price": 349,
    ...
    {
        "id": "P006", "name": "Samsung Galaxy S24 Ultra",
        "category": "Smartphone", "brand": "Samsung", "price": 1299,
    ...
    {
        "id": "P007", "name": "iPhone 15 Pro Max",
        "category": "Smartphone", "brand": "Apple", "price": 1199,
    ...
    {
        "id": "P008", "name": "Levi's 511 Slim Fit Jeans",
        "category": "Clothing", "brand": "Levi's", "price": 70,
...
def build_product_text(p: dict) -> str:
    """
    Build the searchable text for a product.
...
def load_catalog(path: str = None) -> list:
    """Load catalog from JSON file if it exists, else return default."""
...
def save_catalog(catalog: list, path: str = None):
